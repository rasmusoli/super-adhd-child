...
1. Ensure an isolated workspace: use super-adhd-child:using-git-worktrees to create one or verify the existing one
2. Read plan file
...
- **REQUIRED SUB-SKILL:** Use super-adhd-child:finishing-a-development-branch
